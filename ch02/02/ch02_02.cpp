...
extern "C"
{
    extern unsigned int IntegerLogical_(unsigned int a, unsigned int b, unsigned int c,
                                        unsigned int d);

    unsigned int g_Val1 = 0;
}
...
void PrintResults(const char *s, unsigned int a, unsigned int b, unsigned int c,
                  unsigned int d, unsigned int val1, unsigned int r1, unsigned int r2)
{
    const int w = 8;
    const char nl = '\n';
...
int main()
{
    ...
    PrintResults("Test 1", a, b, c, d, g_Val1, r1, r2);
    ...
    r1 = IntegerLogicalCpp(a, b, c, d);
    r2 = IntegerLogical_(a, b, c, d);
    PrintResults("Test 2", a, b, c, d, g_Val1, r1, r2);
